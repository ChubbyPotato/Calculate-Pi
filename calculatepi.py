...
print("I will estimate pi. How many terms should I use? 100")
print("How many decimal places should I use in the result? 7")
print("The approximate value of pi is 3.1315929")